...
public class ContextLoader {
    ...
    protected WebApplicationContext createWebApplicationContext(ServletContext sc) {
        ...
        //如果配置了需要使用的CONTEXT_CLASS,如org.springframework.web.context.support.AnnotationConfigWebApplicationContext
        //那就是用这个class,且这个class必须实现ConfigurableWebApplicationContext接口
        //如果没有额外的配置,就是用默认的 XmlWebApplicationContext
    ...
    protected Class<?> determineContextClass(ServletContext servletContext) {
        ...
        if (contextClassName != null) {
            ...
            //默认使用org\springframework\web\context\ContextLoader.properties中的
